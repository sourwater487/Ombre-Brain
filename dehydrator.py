...
10. 原文里的具体称呼、昵称、互称、自称和原话称谓必须原样保留；不要把这些称呼改写成 {user_display_name}、{ai_name}、用户、AI、assistant 或模型。
...
6. 原文里的具体称呼、昵称、互称、自称和原话称谓必须原样保留；不要把这些称呼改写成 {user_display_name}、{ai_name}、用户、AI、assistant 或模型。
