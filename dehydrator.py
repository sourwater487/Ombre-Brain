...
10. 人称必须服从说话者和 section 语义：{ai_name} 的自述、理解与 ### reflection 必须使用第一人称“我”，绝不能把“我”改写成 {ai_name} 或第三人称；用户原话中的“我”在 ### original 里原样保留，只有整理成客观事实时才写作 {user_display_name}。不要在新叙事中引入或沿用带有明确性别指向的关系称呼；必须指明对象时才使用 {ai_name} 或 {user_display_name}。“宝宝”“宝贝”等无性别称呼可以按原话保留。
...
6. 人称必须服从说话者和 section 语义：{ai_name} 的自述、理解与 ### reflection 必须保持第一人称“我”，绝不能改成 {ai_name} 或第三人称；### original 中的原话人称保持不变。不要在新叙事中引入或沿用带有明确性别指向的关系称呼；必须指明对象时才使用 {ai_name} 或 {user_display_name}。“宝宝”“宝贝”等无性别称呼可以按原话保留。
