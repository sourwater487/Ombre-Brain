...
DEFAULT_CONTEXT_TERMS = (
    # Filtering-only terms. These are not AI-facing labels and are not injected.
    # Keep legacy upstream/private names here so old migrated memories do not
    # become Word Map or recall hub terms.
    "xiaoyu",
    "rain",
    "haven",
    "user",
